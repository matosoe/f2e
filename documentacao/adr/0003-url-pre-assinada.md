...
Quando a URL puder ser resolvida em bucket, key e ETag, o pipeline passa a usar
essa identidade, incluindo `VersionId` quando ele estiver disponível. Expiração
antes da leitura é falha transitória classificada e encaminhada para retry/DLQ;
